...
class Firebase_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $firebase       The name of this plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/firebase-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/firebase-admin.js', array( 'jquery' ), $this->version, false );
