...
Description:  Google Firebase Integration With Wordpress
Version:      1.0.0
...
function firebase_config_install() {
    global $wpdb;
	$wpdb->query("CREATE TABLE IF NOT EXISTS {$wpdb->prefix}firebase");
}
register_activation_hook( __FILE__, 'firebase_config_install' );
...
$WP_Firebase = WP_Comment_Notes::getInstance();
